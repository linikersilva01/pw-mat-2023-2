...
function PokemonInfo({pokemonName}) {
  ...
  // Criando uma unica variavel de estado, do tipo objeto,
  // com a mesma funcionalidade das variaveis de estados avulsas
  // comentadas acima
  ...
  // Usando desestruturação pra criar variaveis de estado somente-leitura
